...
class Settings:
    ...
    EQ = 'darcy_basis_input' # options: 'darcy', 'poisson', 'semilinear_poisson_2', 'semilinear_poisson_3', 'semilinear_poisson_4', 'semilinear_poisson_5', 'sine_gordon'
    N_ex = 10 
    ...
    N_ex_output = 16   # initial fallback/default only
