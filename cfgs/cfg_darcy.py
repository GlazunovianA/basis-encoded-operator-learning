...
class Settings:
    ...
    EQ = 'darcy' # options: 'darcy', 'poisson', 'semilinear_poisson_2', 'semilinear_poisson_3', 'semilinear_poisson_4', 'semilinear_poisson_5', 'sine_gordon'
    N_ex = 10
    ...
    d_features = 4096 # ? why this has huge error when testing?
    basis_u = 'sine' #  'sine'
    ...
    OUTPUT_RANK_CANDIDATES = [8, 12, 16, 20, 24, 32] 
    ...
    PCA_RANK_CANDIDATES = [8, 16, 24, 32, 48, 64]
    OUTPUT_PCA_TOL = 2e-5
